...
<head>
    ...
    <title>Club Members Management System Project</title>
...
<body>
    ...
    <div class="mx-auto bg-[#F6F7FA] rounded-2xl shadow-lg px-16 py-20">
        ...
        <form action="" method="post" class="flex flex-col gap-4">
            <input type="text" class='border rounded-xl px-5 py-3 text-center' placeholder="username">
            <input type="password" class='border rounded-xl px-5 py-3 text-center' placeholder="password">
            <button class="bg-[#002D74] rounded-xl py-2 text-white">Login</button>
            <div class="mt-7 grid grid-col-3  text-grey-400">
                <hr class="border-grey-400">
                <span class="text-center text-sm">OR</span>
                <hr class="border-grey-400">
                
            </div>
            <div class="flex flex-row item-center gap-2">
                <a href="" class="text-[#002D74]">Register</a>
